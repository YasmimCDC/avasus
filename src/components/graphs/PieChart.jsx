    ...
    <div>
      ...
      <div className="pie-legend">
        <div className="row-legend">
            <GoPrimitiveDot className="color-indicator" style={{color: "#FFFFFF"}}></GoPrimitiveDot>
            <p className="text-legend">{labels[0]}: {values[0]}</p>
        </div>
        <div className="row-legend">
            <GoPrimitiveDot className="color-indicator" style={{color: "#D2202C"}}></GoPrimitiveDot>
            <p className="text-legend">{labels[1]}: {values[1]}</p>
        </div>
        <div className="row-legend">
            <GoPrimitiveDot className="color-indicator" style={{color: "#707070"}}></GoPrimitiveDot>
            <p className="text-legend">{labels[2]}: {values[2]}</p>
        </div>
        <div className="row-legend">
            <GoPrimitiveDot className="color-indicator" style={{color: "#2F2E41"}}></GoPrimitiveDot>
